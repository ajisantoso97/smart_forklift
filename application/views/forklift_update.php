   <section class="content-header">
       <h3 style="color:blue;">Edit Data Forklift</h3>
   </section>
   <div class="box">
       <div class="box-header">
           <div class="pull-right">
               <a href="<?= site_url('forklift') ?>" class="btn btn-warning btn-flat">
   ...
   <?php $no = 1;
    foreach ($forklift as $row) { ?>
       ...
       <?php echo form_open('forklift/update_forklift'); ?>
       <div class="col-8">
           <label>No</label>
           <input type="text" name="no" value="<?= $row->intno ?>" class="form-control" required>
       </div>
       <br>
       <div class="col-8">
           <label>Area</label>
